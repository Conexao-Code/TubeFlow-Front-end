...
function LogsAndStats() {
    ...
    const fetchLogs = async () => {
        try {
            ...
            const response = await fetch(`https://api.conexaocode.com/api/logs?${params}`);
    ...
    const fetchStats = async () => {
        try {
            ...
            const response = await fetch(`https://api.conexaocode.com/api/stats?${params}`);
            const data = await response.json();
    ...
    const exportData = async (type: 'logs' | 'stats' | 'all') => {
        try {
            ...
            const response = await fetch(`https://api.conexaocode.com/api/export?${params}`);
