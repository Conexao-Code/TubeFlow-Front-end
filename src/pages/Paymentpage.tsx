...
import { QrCode, ArrowLeft, Check, Shield, Clock, AlertCircle, User, Mail, FileText, Copy, Smartphone, RefreshCw } from 'lucide-react';
...
const PaymentPage: React.FC<PaymentPageProps> = ({ onBack }) => {
  ...
  const validateForm = () => {
    ...
    if (!cpfRegex.test(formData.cpf)) errors.cpf = 'CPF inválido (formato 000.000.000-00)';
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-lg border ${formErrors.name ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors`}
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-4 py-3 rounded-lg border ${formErrors.email ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors`}
                  ...
                  <div>
                    ...
                    <InputMask
                      ...
                      value={formData.cpf}
                      onChange={handleInputChange}
                      className={`w-full px-4 py-3 rounded-lg border ${formErrors.cpf ? 'border-red-500' : 'border-gray-300'} focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors`}
                      placeholder="000.000.000-00"
                      name="cpf"
                    />
                    {formErrors.cpf && <p className="mt-1 text-sm text-red-500">{formErrors.cpf}</p>}
                  </div>
                </div>
                  ...
                  <div className="text-center py-8">
                    ...
                    >
                      ...
                      <p className="text-gray-600 mb-4">
                        Pague em segundos usando o app do seu banco. Preencha seus dados e gere o QR Code.
                      </p>
                  ...
                  >
                    <div className="flex flex-col md:flex-row items-center gap-8">
                      ...
                      <div className="w-full md:w-1/2 space-y-6">
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900 mb-2">Código PIX</h3>
                        ...
                        <div className="space-y-4">
                          ...
                          <ol className="space-y-3 text-sm text-gray-600">
                            <li className="flex items-start gap-3">
                              <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center bg-blue-100 text-blue-600 rounded-full">1</span>
                              <span>Abra o app do seu banco</span>
                            </li>
                            <li className="flex items-start gap-3">
                              <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center bg-blue-100 text-blue-600 rounded-full">2</span>
                              <span>Escolha pagar via PIX com QR Code</span>
                            </li>
                            <li className="flex items-start gap-3">
                              <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center bg-blue-100 text-blue-600 rounded-full">3</span>
