...
function App() {
    ...
    const fetchAdministrators = async () => {
        try {
            const response = await fetch('https://tubeflow-backend.uu2adj.easypanel.host/api/administrators', {
                method: 'GET',
                headers: {
    ...
    const handleEdit = async (e: React.FormEvent) => {
        ...
        if (validateForm() && selectedAdmin) {
            try {
                const response = await fetch(`https://tubeflow-backend.uu2adj.easypanel.host/api/administrators/${selectedAdmin.id}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                    },
                        ...
                        <div className="bg-white rounded-xl shadow-xl w-full max-w-md">
                            ...
                            <form
                                onSubmit={async (e) => {
                                    e.preventDefault();
                                    try {
                                        const response = await fetch('https://tubeflow-backend.uu2adj.easypanel.host/api/register-administrator', {
                                            method: 'POST',
                                            headers: {
                                                'Content-Type': 'application/json',
                                            },
