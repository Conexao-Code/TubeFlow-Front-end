...
// Definindo o tipo para as chaves de BILLING_PERIODS
type BillingPeriodKey = 'MONTHLY' | 'QUARTERLY' | 'ANNUAL';

// Definindo o tipo para os valores de BILLING_PERIODS
type BillingPeriod = {
  label: string;
  price: number;
  discount: number;
  savings?: number; // Opcional, pois nem todos os períodos têm savings
};

// Definindo BILLING_PERIODS com tipagem explícita
    ...
    navigate('/payment', {
      state: {
        plan: {
          ...
          price: BILLING_PERIODS[selectedPeriod].price,
          label: BILLING_PERIODS[selectedPeriod].label
        }
      }
    });
  };
