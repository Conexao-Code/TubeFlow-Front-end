...
const PaymentErrorPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-red-50 to-white py-12 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
      <motion.div
      ...
      >
        ...
        <motion.div
          className="bg-white rounded-2xl shadow-xl p-8 backdrop-blur-lg bg-opacity-90 border border-red-100 mb-8"
          variants={itemVariants}
        >
        ...
        >
          {errorFeatures.map((feature, index) => (
            <motion.div
              key={index}
              className="flex flex-col items-center text-center p-4 rounded-xl bg-white shadow-md hover:shadow-lg transition-all border border-red-100"
